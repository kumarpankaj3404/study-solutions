...
const CompanionsList = (
    { title, companions, classNames }: CompanionListProps) => {
    return (
        <article className={cn('companion-list', classNames)}>
            {companions?.length === 0 ? (
                <div className="flex flex-col  gap-4 items-center justify-center py-10">
                    <Image src="/icons/not-found.svg" alt="empty" width={100} height={100} />
                    <p className="text-lg text-center">No recently completed sessions found. <br /> Either login or create a session with a companion.</p>
                </div>
            ) : (
                <div>
